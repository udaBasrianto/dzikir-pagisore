...
export const dzikirPetangData: DzikirItem[] = [
  ...
  },
  {
    ...
    transliteration: "Amsaynaa wa amsaal mulku lillah walhamdulillah, laa ilaha illallah wahdahu laa syarika lah, lahul mulku walahul hamdu wa huwa 'ala kulli syai-in qodir. Robbi as-aluka khoiro maa fii haadzihil lailati wa khoiro maa ba'dahaa, wa a'udzu bika min syarri maa fii haadzihil lailati wa syarri maa ba'dahaa. Robbi a'udzu bika minal kasali wa su-il kibar. Robbi a'udzu bika min 'adzabin fin naari wa 'adzabin fil qobri.",
  ...
  {
    id: 119,
    title: "Doa Berlindung Sore",
    arabic: "أَعُوْذُ بِكَلِمَاتِ اللهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ",
    transliteration: "A'uudzu bi kalimaatillahit-taammaati min syarri maa khalaq.",
